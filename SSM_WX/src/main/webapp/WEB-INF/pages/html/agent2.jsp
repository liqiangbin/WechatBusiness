...
<body ontouchstart class="bg_gray">
	 <form  action="${pageContext.request.contextPath}/agent/agent2Add.html" method="post" id="formUser">
	...
	<section class="merchant_info">
		<p></p>
			...
			<label></label>
		<input type="text" class="blue arial" style="text-align: center;" value="精英代理商" readonly="readonly" required="required" >
		<input type="hidden" id="type" name="type"  class="blue arial" style="text-align: center;" value="1" readonly="readonly" required="required" >
		</div>
		<div class="merchant_info_detail">
			<label>代理商姓名</label>
			<input type="text" id="name" name="name" required="required" placeholder="代理商姓名">
		</div>
		<div class="merchant_info_detail">
			<label>微信</label>
			<input type="text" id="weixin" name="weixin" required="required" placeholder="代理商微信">
		</div>
		<div class="merchant_info_detail">
			<label>电话</label>
			<input type="tel" id="tel" name="tel"  required="required"  placeholder="代理商电话">
		</div>
	...
	function chooseAgent(id,name){
		$("#agentLabel").val(name);
		$("#refereeWeixin").val(id);
		console.log("直属领导选择："+id+"|"+name);
	}
