				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-user"><a href="javascript:;"
						...
						<ul class="dropdown-menu dropdown-menu-default">
							<li class="divider"></li>
							<li><a href="${pageContext.request.contextPath}/manager/editPassword.html"> <i class="icon-lock"></i>
									密码修改
							</a></li>
							<li><a href="${pageContext.request.contextPath}/manager/logout.html" > <i class="icon-key"></i> 退出
							</a></li>
						</ul></li>
...
<script type="text/javascript">
 var ss="${ sessionScope.manager}"
 	if(ss==null|| ss ==''){
 		window.location.href="${pageContext.request.contextPath}/manager/logout.html"; 
 	}
</script>
